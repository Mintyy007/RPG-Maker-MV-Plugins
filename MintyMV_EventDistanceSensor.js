...
Game_System.prototype.initialize = function() {
  Mintyy.Sensor.structAlias.Game_System.initialize.apply(this, arguments);
  this._pageCommand = 'A';
}

Game_Interpreter.prototype.pluginCommand = function(command, args) {
  Mintyy.Sensor.structAlias.Game_Interpreter.pluginCommand.apply(this, arguments);
  switch(command) {
    case 'setSensorPage':
      if (args[0] === 'A') {
...
{
    Mintyy.Sensor.structAlias.Game_Event.initialize.apply(this, arguments);
    this.setSensorAndShift();
};

Game_Event.prototype.update = function()
{
    Mintyy.Sensor.structAlias.Game_Event.update.apply(this, arguments);
