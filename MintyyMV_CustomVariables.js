...
==================================================
PATREON: https://www.patreon.com/Mintyy
==================================================

*/

var Imported = Imported || {};
Imported.MintyyMV_CustomVariables = true;

var Mintyy = Mintyy || {};
Mintyy.CV = Mintyy.CV || {};

var cvparams = PluginManager.parameters('MintyyMV_CustomVariables');

var variableLimit = Number(cvparams['Custom Variable Max']);

Mintyy.CV.GameSystem_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
    Mintyy.CV.GameSystem_initialize.call(this);
...
Mintyy.CV.GameInterpreter_pluginCommand = Game_Interpreter.prototype.pluginCommand;
Game_Interpreter.prototype.pluginCommand = function(command, args) {
    Mintyy.CV.GameInterpreter_pluginCommand.call(this, command, args);
    if (command === 'cv') {
        if (args[0] === 'val') {
