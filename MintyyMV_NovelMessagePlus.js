 ...
 * @author Yoji Ojima, Sasuke KANNAZUKI, Mintyy
 *
 ...
 *
 ...
 Novel Message Plus
 Authors: 4f3./Tatsumi, Yoji Ojima, Sasuke Kannazuki
...
Imported.EX4f3tNVL = Imported.EX4f3tNVL || {};

var rmExtat = rmExtat || {};
rmExtat.NVLMode = rmExtat.NVLMode || {};

var parametersNVL = PluginManager.parameters('MintyyMV_NovelMessagePlus');

rmExtat.NVLMode.nvlSwitch = Number(parametersNVL['NVL Mode Switch']);
rmExtat.NVLMode.choiceListX = eval(parametersNVL['Default ChoiceList X']);
rmExtat.NVLMode.choiceListY = eval(parametersNVL['Default ChoiceList Y']);

(function() {

    rmExtat.NVLMode.Game_System_initialize = Game_System.prototype.initialize;
    Game_System.prototype.initialize = function() {
        rmExtat.NVLMode.Game_System_initialize.call(this);
        this._placementX = 0;
        this._placementY = 0;
        this._placementW = Graphics.width;
        this._placementH = Graphics.height;

        this._choiceListX = rmExtat.NVLMode.choiceListX;
        this._choiceListY = rmExtat.NVLMode.choiceListY;
    }
    ...
    function isNovelMode() {
        return $gameSwitches.value(rmExtat.NVLMode.nvlSwitch);
    };
    ...
    rmExtat.NVLMode.Window_ChoiceList_updatePlacement = Window_ChoiceList.prototype.updatePlacement;
    Window_ChoiceList.prototype.updatePlacement = function() {
        // I readressed this one because I think that you would want to see where your novel
        // choices are called.
        rmExtat.NVLMode.Window_ChoiceList_updatePlacement.call(this); // calling original method
        if (isNovelMode()) {
